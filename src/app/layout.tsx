  ...
  return (
    <html lang="en" className={`${inter.variable} ${sora.variable} h-full`}>
      <body className="min-h-full antialiased">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:rounded-md focus:bg-aqua-400 focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-ocean-950"
        >
          Skip to content
        </a>
